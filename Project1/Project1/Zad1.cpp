...

{
	...
	GLboolean error = load_targa("man_black_skin_face_2_20141210_1170675123.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku man_black_skin_face_2_20141210_1170675123.tga");
	...
	error = load_targa("man_black_skin_face_2_20141210_1170675123.tga", width, height, format, type, pixels);
...

{
	...
	glutAddMenuEntry("man_black_skin_face_2_20141210_1170675123.tga (kompresja)", TEXTURE_LENA);

	glutAddMenuEntry("man_black_skin_face_2_20141210_1170675123.tga (bez kompresji)", TEXTURE_LENA_UNC);

	glutAddMenuEntry("man_black_skin_face_2_20141210_1170675123.tga (kompresja)", TEXTURE_LENA_GRAY);

	glutAddMenuEntry("man_black_skin_face_2_20141210_1170675123.tga (bez kompresji)", TEXTURE_LENA_GRAY_UNC);
